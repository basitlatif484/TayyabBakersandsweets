 ...
 <%@ Page Title="" Language="C#" MasterPageFile="~/Adminmaster.Master" AutoEventWireup="true" CodeBehind="Edititem.aspx.cs" Inherits="TayyabBakersandsweets.Edititem" %>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6 offset-md-3">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center" style="font-weight:bold;font-size:25px;font-family:Calibri;">Update item</h5>
        ...
        <div class="row mb-3">
            <div class="col-sm-6">
                ...
                <asp:HiddenField ID="hidden_itemid" runat="server"  />
    ...
    <div class="col-sm-12">
        ...
        <div class="row mb-3">
            <div class="col-md-6 col-12 offset-md-3 text-center">
                <asp:Button runat="server" OnClick="btnAdd_Click" CssClass="form-control btn btn-primary" Text="Update" />
            </div>
        </div>
    </form>
